...
maleTurnstile = threading.Semaphore(3)
femaleTurnstile = threading.Semaphore(3)
...
class threadMale (threading.Thread):
	...
	if maleLock.counter == 0:
		femaleTurnstile.release()
		femaleTurnstile.release()
		femaleTurnstile.release()
		if femaleLock.counter == 0:
			maleTurnstile.release()
			maleTurnstile.release()
			maleTurnstile.release()
