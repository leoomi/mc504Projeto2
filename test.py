...
maleTurnstile = threading.Event()					  #evento que sinalizara caso a fila do sexo oposto tenha mais de 4 pessoas
femaleTurnstile = threading.Event()
maleTurnstile.set()									  #libera, inicialmente, esses eventos
femaleTurnstile.set()
...
while True: # main game loop
    ...
    text = font.render("Mulheres na Fila:" + str(femaleLock.naFila), 1, (255, 255, 255))
    info.blit(text,(10,250))
    text = font.render("Homens na Fila:" + str(maleLock.naFila), 1, (255, 255, 255))
